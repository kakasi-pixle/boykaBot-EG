...
${lenguajeGB.smsAutoLv6()}`, fkontak, {contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' 😻 𝗦𝘂𝗽𝗲𝗿 𝗚𝗮𝘁𝗮𝗕𝗼𝘁-𝗠𝗗 - 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽 ', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}) */
conn.sendButton(m.chat, '🐈 𝐁𝐎𝐀𝐘𝐊𝐀|𝐇𝐚𝐫𝐥𝐞𝐲'╭━⊰ ${username} ⊱━დ
┃ ${lenguajeGB.smsAutoLv2()} ${before}
┃ ${lenguajeGB.smsAutoLv3()} ${user.level}
┃ ${lenguajeGB.smsAutoLv4()} ${user.role}
┃ ${lenguajeGB.smsAutoLv5()} ${new Date().toLocaleString('id-ID')}
...
${lenguajeGB.smsAutoLv6()}, null, [[lenguajeGB.smsConMenu(), `.اوامر]], null, null, fkontak)
