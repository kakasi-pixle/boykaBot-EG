...
> ♻️ .كومنت
> ♻️ .باركود
*القسم غير مكتمل مؤقتا استمتعو 😁❤️*
*⎔⋅ ╼╃ ⊰ •﹝❄️﹞• ⊱ ╄╾ ⋅⎔*
*~⌬ تــ✍️︎ــوقــيــع ↡~*🖋
*⌞⚜️┊𝐒𝐩𝐞𝐞𝐝 ス 𝐊.𝐠.𝐦┊⚜️⌝*
*⎔⋅ ╼╃ ⊰ •﹝❄️﹞• ⊱ ╄╾ ⋅⎔*`
...
handler.command = /^(ق6|قسم التحويلات|التحويلات|memú|help|info|comandos|allmenu|2help|menu1.2|ayuda|commands|commandos|cmd)$/i;
handler.exp = 50;
handler.fail = null;
