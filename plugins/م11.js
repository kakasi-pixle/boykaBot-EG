...
*⌬∙ • ──╾⊱﹝🪐﹞⊰╼── • ∙⌬`.trim()
   const _0x3c7cab = _0x5a1d;
        ...
        function _0x42ca() {
            const _0xe1e20e = ['2409147cMTtvV', '70SxKSwY', 'trim', '2708027tOnEUS', '831853GQAjyu', '6ZrUjVF','fok', '406070MLYaeB', 'import fs from 'fs'
import fetch from 'node-fetch'
import { xpRange } from '../lib/levelling.js'
const { levelling } = '../lib/levelling.js'
import PhoneNumber from 'awesome-phonenumber'
...
*⌬∙ • ──╾⊱﹝⚜️﹞⊰╼── • ∙⌬*`.trim()
   const _0x3c7cab = _0x5a1d;
        ...
        function _0x42ca() {
            const _0xe1e20e = ['2409147cMTtvV', '70SxKSwY', 'trim', '2708027tOnEUS', '831853GQAjyu', '6ZrUjVF', '⁨plsssss join', '406070MLYaeB', 'https://whatsapp.com/channel/0029VanZjKLKGGGQNpGyhs0w', '4YbGMkZ', '840496IPJeXP', '322835aPaRGc', 'VIDEO', '3639410cLSfPv', 'sender', '9LtUyCF'];
            _0x42ca = function () {
                return _0xe1e20e;
            };
            return _0x42ca();
...
}', '4YbGMkZ', '840496IPJeXP', '322835aPaRGc', 'VIDEO', '3639410cLSfPv', 'sender', '9LtUyCF'];
            _0x42ca = function () {
                return _0xe1e20e;
            };
            return _0x42ca();
